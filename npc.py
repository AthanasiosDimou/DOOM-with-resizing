...
class NPC(AnimatedSprite):
    ...
    def draw_ray_cast(self):
        ...
        pg.draw.circle(self.game.screen, 'red', (width * self.x, height * self.y), 15)
        if self.ray_cast_player_npc():
            pg.draw.line(self.game.screen, 'orange', (width * self.game.player.x, height * self.game.player.y),
                         (width * self.x, height * self.y), 2)
